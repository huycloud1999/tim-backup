...
export const MacroEconomy = ({ data }) => {
  ...
  return (
    <>
      ...
      <div className="major-city">{risingFromTheAshes.subText}</div>
      <div className="major-city-charts">
        ...
        <div className="image-chart vietnamese-income image-container">
          <div className="text">
            {Array.isArray(risingFromTheAshes.chartArea.chartItem) &&
            risingFromTheAshes.chartArea.chartItem.length > 0
              ? risingFromTheAshes.chartArea.chartItem[0].title
              : ""}
          </div>
          <Image
            src={
              Array.isArray(risingFromTheAshes.chartArea.chartItem) &&
              risingFromTheAshes.chartArea.chartItem.length > 0
                ? risingFromTheAshes.chartArea.chartItem[0]?.chartImage
                    ?.sourceUrl || ""
                : ""
            }
            layout="fill"
            className="image-item"
            alt="vietnamese-income"
          />
        ...
        <div className="image-chart GDP image-container">
          <div className="text">
            {Array.isArray(risingFromTheAshes.chartArea.chartItem) &&
            risingFromTheAshes.chartArea.chartItem.length > 1
              ? risingFromTheAshes.chartArea.chartItem[1]?.title || ""
              : ""}
          </div>
          <Image
            src={
              Array.isArray(risingFromTheAshes.chartArea.chartItem) &&
              risingFromTheAshes.chartArea.chartItem.length > 1
                ? risingFromTheAshes.chartArea.chartItem[1]?.chartImage
                    ?.sourceUrl || ""
                : ""
            }
            layout="fill"
      ...
      <div className="populous-countries">
        <SmallTitle
          className="text__Populous_Countries"
            ...
            return (
              <>
                {visible && (
                  <ChartImage
                    key={index}
                    image={value.chartImage.sourceUrl}
                    title={value.title}
                    source={value.source}
                  />
                )}
        ...
        <div className="trade-chart">
          ...
          <div className="legend">
            <div className="legend-item">
              ...
              <div className="title">
                {populousCountries.tradeChart.header[1]}
              </div>
            </div>
            <div className="legend-item">
              <span className="label"></span>
              <div className="title">
                {populousCountries.tradeChart.header[2]}
              </div>
            </div>
          </div>
          <div className="source">GSO</div>
        ...
        <SmallTitle title={tigerSection.title}>
        ...
        <div className="favorable-destination">
          ...
          <div className="text small-title ">
            {tigerSection.vietnamCircleChart.title}
          </div>
          ...
          <div className="content-area">
            ...
            {tigerSection.vietnamCircleChart.iconTagBoxItem.map(
              (value, index) => {
                return (
                  <IconBoxTag
                    key={index}
                    icon={value.icon.sourceUrl}
                    title={value.title}
        ...
        <div className="growth-engine border-blue">
          ...
          <div className="image-container growth-image growth-image-PC">
            <Image
              src={tigerSection.vietNamGrowthEngine.fullCoverImage.sourceUrl}
              alt="growth"
              className="image-item"
              layout="fill"
            />
          ...
          <div className="image-container growth-image growth-image-Mobile">
            <Image
              src={
                tigerSection.vietNamGrowthEngine.fullCoverImageMobile.sourceUrl
              }
              alt="growth"
              className="image-item"
              layout="fill"
          ...
          <div className="population">
            <div className="column-1">
              <div className="text">Population of Vietnam</div>
              <div className="image-container image">
                <Image
                  src={
                    tigerSection.vietNamGrowthEngine.populationChart.image
                      .sourceUrl
                  }
                  className="image-item"
                  alt="populationChart"
            ...
            <div className="column-2">
              {tigerSection.vietNamGrowthEngine.statistics.map(
                (value, index) => {
                  return (
                    <div key={index} className="icon-box">
                      <div className="image-container icon">
                        <Image
                          src={value.icon.sourceUrl}
                          alt="human"
                          layout="fill"
                          className="image-item"
                        />
