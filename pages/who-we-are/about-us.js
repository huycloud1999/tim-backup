...
export default function About(props) {
  ...
  return (
    <>
      <HeroSection title={props.about.HeroSection.title}
      // image={props.about.HeroSection.image.sourceUrl} 

      />
      <div className="container">
        <div className='about_description animation-paragraph' ref={el => { paragraph.current.push(el) }} dangerouslySetInnerHTML={{ __html: ab.description.content }}>
        ...
        <div className="about_description_2 animation-paragraph" ref={el => { paragraph.current.push(el) }} >
        ...
        <div className="about_tow">
          <div className="about_tow_content container">
            <div className="image-container about_img " >
              <Image src={ab.timByNumber.image.sourceUrl} alt="image About" className="about__img image-item" layout="fill" />
            </div>
            <div className="about_text">
              <div className="about_title">
                <h3>{props.about.aboutUs.timByNumber.heading}</h3>
                <p>
                  {props.about.aboutUs.timByNumber.title}
                </p>
              </div>
                ...
                <div className="countdown-grid  about_countDown_content">
                  {
                    ab.timByNumber.countdown.map((value, index) => {
                      ...
                      return (
                        <Countdown className="about_countDown_text" key={index} isSymbol={isVisible} startNumber={value.number - 10} number={value.number}>
                          {value.description}
                        </Countdown>
                      )
                    })
