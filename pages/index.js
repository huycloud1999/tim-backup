...
export default function Home(props) {
  ...
  const { monthlyHighlight, whatWeDo: WhatWeDo, textAnimationSection: TextAnimationSection, countdownSection: CountDown, videoSection: VideoSection } = props.AllInfo
  ...
  return (
    <div>
      ...
      <div className="what-we-do">
        <div className="container">
          ...
          <div className="description">
            <div className="text" dangerouslySetInnerHTML={{ __html: WhatWeDo.blackText }}></div>
            <div className="gradient-text">{WhatWeDo.gradientText}</div>
          </div>
        </div>
      </div>

      <Video poster={VideoSection.poster.sourceUrl} url={VideoSection.video.url} />
      ...
      <div className="about-us-countdown">
        <div className="container">
          <div className="info-area">
            <div className="heading" dangerouslySetInnerHTML={{ __html: CountDown.sectionTitle }}>
          ...
          <div className="countdown-grid">
            {
              CountDown.countdown.countdownItem.map((value, index) => {
                ...
                return (
                  <Countdown key={index} isSymbol={isVisible} startNumber={value.number - 10} number={value.number}>
                    {value.description}
                  </Countdown>
          ...
          <Button className={"hideOnDesktop hideOnTablet"} link='/who-we-are/our-team' />
        </div>
      </div>
      ...
      <div className="monthly-highlights">
        <div className="container">
          <div className="info">
            <div className="heading" dangerouslySetInnerHTML={{ __html: props.HightLights.title }}></div>
